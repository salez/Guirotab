...
public static class ExtensionsMethods
{
    ...
    public static MvcHtmlString ActionLinkPermissao(this HtmlHelper helper, string linkText, string actionName, string controllerName)
    {
        if (Sessao.Site.VerificaPermissao(actionName, controllerName))
        {

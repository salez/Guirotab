	...
	<div class="conteudo-baixo">
		...
		<div class="vas-visualizar">
                ...
                <div style="clear: both; padding: 10px 0 0;">
                    <a href="javascript:comentarVA();" style="padding:0 8px;" class="botao">Comentar</a>
                    <% if (Model.IsPendente() || Model.IsReprovado() && Model.Status != (char)Models.ProdutoVa.EnumStatus.Inativo && Autenticacao.AutorizaPermissao("aprovar", "produtosvas"))
                        { %>
					    <a href="javascript:AprovarVA();" style="padding:0 1px 0 0;" class="botaoAprovar">Aprovar</a>
                    <% } %>
                    ...
                    <%
    				    ...
    				    <a href="javascript:AprovarEPublicarVA();" style="width:120px; background:url(../../images/botao_aprovar_publicar.jpg) no-repeat !important; padding:0 11px 0 10px;" class="botao">Aprovar e Publicar</a>

                    <% } %>

                    <% if (!Model.IsReprovado() && !Model.IsAtivo() && Autenticacao.AutorizaPermissao("aprovar", "produtosvas"))
                        { %>
					    <a href="javascript:ReprovarVA();" class="botaoReprovar">Reprovar</a>
                    <% } %>
				</div>

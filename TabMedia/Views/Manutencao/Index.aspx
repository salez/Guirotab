...
<head id="Head1" runat="server">
    <title>Manutenção - <%=Util.Sistema.AppSettings.NomeSistema %></title>
    ...
    <div>
        <form method="post" action="">
            ...
            <div class="erro" style="position: absolute; left: 50%; margin-left: -400px; width: 800px; text-align: center; top: 50%; height: 300px; margin-top: -150px;">
                <img src="http://www.tabmedia.com.br/nycomed/images/logo_tabmedia_login.jpg" />
                <br /><br />
                <p>
                   O sistema está passando por uma manutenção nesse momento.  A previsão de retorno é as 0h30.
                </p>
                <br />
                <p>

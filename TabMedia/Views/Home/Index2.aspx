        ...
        function GetRelatorioUtilizacao() {
            ...
            $('.ddlHabilitar').change(function () {
                ...
                if ($(this).val() == '') {
                    ...
                    $('#aHabilitar').attr('href', 'emspresentations://update?territory=' + $(this).val());
                }
            });
...
--%>
    <div class="conteudo-baixo">
        ...
        <a class="botao_instalar" href="itms-services://?action=download-manifest&url=http://www.guiropatab.com/app/gerentes/manifest.plist" target="_blank">Instalar</a>  
        ...
        <br /><br /><a href="" style="margin-left: 0;" id="aHabilitar" class="botao_habilitar">Habilitar</a>
